...
module.exports = (
    ...
    * @param {string}[uuid] optional.
     ...
     */
    (size, timeBucket, albumId, isArchived, isFavorite, isTrashed, key, order, personId, uuid, withPartners, withStacked) => {
        let res = {
            method: "get",
        ...
        res.path = argParser(res.path, timeBucket, 'timeBucket')
        ...
        res.path = argParser(res.path, personId, 'personId')
